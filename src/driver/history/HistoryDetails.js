      ...
      <div className="content">
        <div className="title-page">
          ...
          <div className="ml-auto show">
            <button
              onClick={() => navigate(-1)}
              class="bg-blue-1 hover:bg-blue-3 text-white py-2 px-6 rounded-lg tracking-wider shadow-sm"
            >
              KEMBALI
            </button>
          </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <p class="text-gray-600 whitespace-no-wrap">7:28:09 AM</p>
                    </td>
                    <td>
                      <p class="text-gray-900 whitespace-no-wrap">
                        August 8th 2022
                    ...
                    <td>
                      <span class="relative inline-block px-3 py-1 leading-none text-center">
                        <span
                          aria-hidden="true"
                          class="bg-green-2 opacity-25 absolute inset-0 rounded-full"
                        ></span>
                        <span class="relative text-xs text-green-1 font-medium">
                          Sudah Diterima
                        </span>
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="relative inline-block px-3 py-1 leading-none text-center">
                        <span
                          aria-hidden="true"
                          class="bg-yellow-2 opacity-25 absolute inset-0 rounded-full"
                        ></span>
                        <span class="relative text-xs text-yellow-1 font-medium">
                          Dalam Perjalanan
                        </span>
                      </span>
                    </td>
