        ...
        <div className="container">
                <div className="content">
                    ...
                    <div className="drop-shadow">
                        <div className="bg-pink-1 mt-6 py-4 px-10 rounded-t-lg">
                        ...
                        <div className="py-5 px-10 rounded-b-lg bg-white">
                            ...
                            <div>
                                <p className="font-bold mb-2 mt-5">Nomor SJP</p>
                                <div class="w-fullinline-block relative text-sm">
                                    <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                            ...
                            <div>
                                <p className="font-bold mb-2 mt-5">Point Awal</p>
                                <div class="w-fullinline-block relative text-sm">
                                    <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                            ...
                            <div>
                                <p className="font-bold mb-2 mt-5">Point Tujuan</p>
                                <div class="w-fullinline-block relative text-sm">
                                    <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                            ...
                            <div className="flex justify-end">
                                ...
                                {/* <Link to='/tracking'>
                                    <button onClick={toast_success} class="bg-pink-1 hover:bg-pink-2 text-white mt-4 font-bold py-2 px-6 rounded-lg tracking-widest drop-shadow">
                                        START
                                    </button>
                                </Link> */}
                            </div>
