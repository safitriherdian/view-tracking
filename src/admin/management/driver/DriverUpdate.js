...
function toast() {
    ...
    Toast.fire({
        icon: 'success',
        title: 'Successfully updated driver data'
    })
}
                    ...
                    <div className='card mt-6'>
                        ...
                        <div className='flex mt-10'>
                            ...
                            <button onClick={() => navigate(-1)} class="btn-back hover:bg-blue-3">
                                ...
                                <Link to='/admin/management/driver'>
                ...
                <div className="pt-20 ">
                    <div className="content">
                        ...
                        <div className="flex flex-row items-center">
                            ...
                            <p className="text-xl menuIcons text-white">Daftar Driver</p>
                        </div>
